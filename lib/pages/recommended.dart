...
class RecommendationResult extends StatelessWidget {
  final Map argument;
  const RecommendationResult({Key? key,required this.argument}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Padding(padding: EdgeInsets.only(left: 25,top: 15),child: Text("Recommendation Result",style: TextStyle(color: Colors.white,fontSize: 25,fontWeight: FontWeight.bold),),),
          Padding(padding: EdgeInsets.only(left: 25,top: 15),child: Text("Result obtained using on-edge decision tree model",style: TextStyle(color: Colors.green[800],fontWeight: FontWeight.bold),),),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: 10,),
                Text("Recommended Crop:",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.grey[700]),),
                SizedBox(height: 10,),
                ...
                Text("Given Parameters",style: TextStyle(color: Colors.green,fontSize: 17,fontWeight: FontWeight.bold),),
                SizedBox(height: 20,),
                Row(
                  children: [
                    Container(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text("Average Rainfall",style: TextStyle(fontSize: 15),)
                          ],
                        )
                      ],
                    )
