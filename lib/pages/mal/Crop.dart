...
class CropMal extends StatelessWidget {

  final Map arguments;

  const CropMal({Key? key,required this.arguments}) : super(key: key);
      ...
      body:Stack(
            children: [
              ...
              SizedBox(
                ...
                child: Image.asset("assets/images/${arguments["pic"]}.jpg",fit: BoxFit.cover,),
              ),
              Positioned(
                left: 0,
                ...
                child: Container(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      SizedBox(height: 15,),
                      TextButton(onPressed: ()async{await canLaunch(arguments["link"]) ? await launch(arguments["link"]) : throw 'Could not launch ${arguments["link"]}';}, child: Text("കൂടുതൽ അറിയുക",style: TextStyle(fontSize: 16),),style: TextButton.styleFrom(backgroundColor: Colors.green,primary: Colors.white,shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),padding: EdgeInsets.all(15)),)
                    ],
                  ),
