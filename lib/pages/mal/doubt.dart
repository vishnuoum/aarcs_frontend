...
class DoubtMal extends StatefulWidget {
  final Map arguments;
  const DoubtMal({Key? key,required this.arguments}) : super(key: key);

  @override
  State<DoubtMal> createState() => _DoubtMalState();
}

class _DoubtMalState extends State<DoubtMal> {
