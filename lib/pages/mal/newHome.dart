...
class Home2Mal extends StatefulWidget {
  Home2Mal({Key? key}) : super(key: key);

  @override
  _Home2MalState createState() => _Home2MalState();
}

class _Home2MalState extends State<Home2Mal> {
            ...
            child:Row(
              ...
              children: [
                ...
                Card(
                  ...
                  child: InkWell(
                    onTap: (){
                      Navigator.pushNamed(context, "/recommendMal");
                    },
                    borderRadius: BorderRadius.circular(10),
                    child: Container(
                      height: 100,
