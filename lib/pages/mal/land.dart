...
class LandMal extends StatefulWidget {
  const LandMal({Key? key}) : super(key: key);

  @override
  _LandMalState createState() => _LandMalState();
}

class _LandMalState extends State<LandMal> {
    ...
    return WillPopScope(
        ...
        child: Scaffold(
          appBar: AppBar(
              ...
              ):Text("ഭൂമി കടം കൊടുക്കുക",style: TextStyle(color: Colors.green),),
              actions: !isSearch?[
              ...
              PopupMenuButton(itemBuilder: (context) {
                return List.generate(2, (index) {
                  var options=["ചേർക്കുക","നിങ്ങളുടെ ഭൂമികൾ"];
                  ...
                  onSelected:(index)async{
                    switch(index){
                      case 0:{
                        await Navigator.pushNamed(context,"/addNewLandMal");
                        setState(() {
                          loading=true;
                          result=[];
                        });
                      ...
                      case 1:{
                        await Navigator.pushNamed(context, "/userLandsMal",);
                        setState(() {
                          loading=true;
                          result=[];
                        });
