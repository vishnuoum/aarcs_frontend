...
class MarketPlaceMal extends StatefulWidget {
  const MarketPlaceMal({Key? key}) : super(key: key);

  @override
  _MarketPlaceMalState createState() => _MarketPlaceMalState();
}

class _MarketPlaceMalState extends State<MarketPlaceMal> {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          ):Text("മാർക്കറ്റ് പ്ലേസ്",style: TextStyle(color: Colors.green),),
          actions: !isSearch?[
            ...
            PopupMenuButton(
              ...
              return List.generate(2, (index) {
                var options=["ചേർക്കുക","നിങ്ങളുടെ ഇനങ്ങൾ"];
              ...
              onSelected:(index)async{
                switch(index){
                  case 0:{
                    await Navigator.pushNamed(context, "/addNewCropMal",);
                    setState(() {
                      loading=true;
                      result=[];
                    });
                  ...
                  case 1:{
                    await Navigator.pushNamed(context, "/userItemsMal",);
                    setState(() {
                      loading=true;
                      result=[];
                    });
