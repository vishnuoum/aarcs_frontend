...
class MyQueriesMal extends StatefulWidget {
  const MyQueriesMal({Key? key}) : super(key: key);

  @override
  State<MyQueriesMal> createState() => _MyQueriesMalState();
}

class _MyQueriesMalState extends State<MyQueriesMal> {
        ...
        child: Text('ഒന്നും കാണിക്കാനില്ല',style: TextStyle(color: Colors.grey),),
          ...
          itemBuilder: (context,index) {
            return GestureDetector(
              onTap: ()async{
                await Navigator.pushNamed(context, "/myDoubtMal",arguments: {"resolved":result[index]["resolved"],"phone":sharedPreference.getString("phone"),"id":result[index]["id"],"username":result[index]["username"],"district":result[index]["district"],
                      ...
                      child: Padding(
                        ...
                        child: Align(
                          ...
                          child: Container(
                            ...
                            child: Text("${result[index]["answers"]} ഉത്തരങ്ങൾ"),
                          ),
                        ),
                      ),
                    ),
