...
class AddNewLandMal extends StatefulWidget {
  const AddNewLandMal({Key? key}) : super(key: key);

  @override
  _AddNewLandMalState createState() => _AddNewLandMalState();
}

class _AddNewLandMalState extends State<AddNewLandMal> {
    ...
    return Scaffold(
      ...
      body: Form(
        child: ListView(
          ...
          children: [
            Align(child: Text("നിങ്ങളുടെ ഭൂമി ചേർക്കുക",style: TextStyle(color: Colors.green,fontSize: 30,fontWeight: FontWeight.bold),),alignment: Alignment.centerLeft,),
            SizedBox(height: 40,),
            Container(
