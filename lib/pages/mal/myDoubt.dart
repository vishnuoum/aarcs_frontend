...
class MyDoubtMal extends StatefulWidget {
  final Map arguments;
  const MyDoubtMal({Key? key,required this.arguments}) : super(key: key);

  @override
  State<MyDoubtMal> createState() => _MyDoubtMalState();
}

class _MyDoubtMalState extends State<MyDoubtMal> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("ചോദ്യത്തിന് ഉത്തരം നൽകുക"),
      ),
      body: Container(
            ...
            children: [
              ListView(
                children: [
                  GestureDetector(
                    onTap: (){
                      Navigator.pushNamed(context, "/viewPicMal",arguments: {"pic":widget.arguments["pic"]});
                    },
                    child: Hero(
                      tag: "1",
                      child: Container(
                  ...
                  SizedBox(height: 10,),
                  ListTile(
                      title: Text("എന്ന് ചോദിച്ചു",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17),),
                  ...
                  SizedBox(height: 20,),
                  Center(
                    child: Text("പ്രതികരണങ്ങൾ",style: TextStyle(color: Colors.green[800],fontSize: 17,fontWeight: FontWeight.bold),),
                  ),
                  SizedBox(height: 10,),
                  loading?Center(
                    child: Column(
                          ...
                          children: [
                            ListTile(
                                ...
                                trailing: widget.arguments["resolved"]!=null?SizedBox():DropdownButton<String>(
                                  ...
                                  items: <String>['ഉത്തരമായി അടയാളപ്പെടുത്തുക'].map((String value) {
                      ...
                      Expanded(flex: 8,child: Container(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                              hintText: "നിങ്ങളുടെ പ്രതികരണം എഴുതുക",
