...
class UserToolsMal extends StatefulWidget {
  const UserToolsMal({Key? key}) : super(key: key);

  @override
  _UserToolsMalState createState() => _UserToolsMalState();
}

class _UserToolsMalState extends State<UserToolsMal> {
  bool isSearch=false;
      ...
      return StatefulBuilder(builder: (BuildContext context,setState){
        return Container(
          child: ListView(
            ...
            children:[
              SizedBox(height: 60,),
              Align(child: Text("എഡിറ്റ്",style: TextStyle(color: Colors.green,fontSize: 30,fontWeight: FontWeight.bold),),alignment: Alignment.centerLeft,),
              SizedBox(height: 40,),
              Text("ഉപകരണത്തിന്റെ പേര്"),
              Container(
    ...
    return WillPopScope(
        ...
        child: Scaffold(
          appBar: AppBar(
              ...
              ):Text("നിങ്ങളുടെ ഉപകരണങ്ങൾ",style: TextStyle(color: Colors.green),),
              actions: !isSearch?[
