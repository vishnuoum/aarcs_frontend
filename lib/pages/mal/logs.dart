...
class LOGSMal extends StatefulWidget {
  const LOGSMal({Key? key}) : super(key: key);


  @override
  _LOGSMalState createState() => _LOGSMalState();
}

class _LOGSMalState extends State<LOGSMal> {
