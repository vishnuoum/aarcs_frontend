...
class AddNewCrop extends StatefulWidget {
  ...
  @override
  _AddNewCropState createState() => _AddNewCropState();
}
    ...
    return Scaffold(
      ...
      body: Form(
        child: ListView(
          ...
          children: [
            Align(child: Text("Add Your Item",style: TextStyle(color: Colors.green,fontSize: 30,fontWeight: FontWeight.bold),),alignment: Alignment.centerLeft,),
            SizedBox(height: 40,),
            Container(
