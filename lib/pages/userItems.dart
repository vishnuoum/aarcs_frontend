    ...
    showModalBottomSheet(enableDrag: true,isScrollControlled: true,shape: RoundedRectangleBorder(borderRadius: BorderRadius.only(topRight: Radius.circular(10),topLeft: Radius.circular(10))),context: context, builder: (BuildContext context){
      return Container(
        child: ListView(
          ...
          children:[
            SizedBox(height: 60,),
            Align(child: Text("Edit Item",style: TextStyle(color: Colors.green,fontSize: 30,fontWeight: FontWeight.bold),),alignment: Alignment.centerLeft,),
            SizedBox(height: 40,),
            Text("Item Name"),
            Container(
            ...
            TextButton(onPressed: ()async{
              ...
              if(name.text.length!=0 && price.text.length!=0 && place.text.length!=0 && district!="Select a Distirct"){
                var res=await listService.editUserItems(name:name.text,price: price.text, district: district,id:id,place: place.text);
                if(res=="done"){
                                ...
                                ClipOval(
                                  child: Material(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async{
                                        showBottomSheet(context, result[index]["id"]);
                                      },
