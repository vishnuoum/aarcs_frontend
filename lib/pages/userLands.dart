...
class UserLands extends StatefulWidget {
  const UserLands({Key? key}) : super(key: key);

  @override
  _UserLandsState createState() => _UserLandsState();
}

class _UserLandsState extends State<UserLands> {
  bool isSearch=false;
      ...
      return StatefulBuilder(builder: (BuildContext context,setState){
        return Container(
          child: ListView(
            ...
            children:[
              SizedBox(height: 60,),
              Align(child: Text("Edit Land",style: TextStyle(color: Colors.green,fontSize: 30,fontWeight: FontWeight.bold),),alignment: Alignment.centerLeft,),
              SizedBox(height: 40,),
              Text("Land Name"),
              Container(
    ...
    return WillPopScope(
        ...
        child: Scaffold(
          appBar: AppBar(
              ...
              ):Text("Your Land",style: TextStyle(color: Colors.green),),
              actions: !isSearch?[
