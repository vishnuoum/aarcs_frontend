...
class AddNewTool extends StatefulWidget {
  const AddNewTool({Key? key}) : super(key: key);

  @override
  _AddNewToolState createState() => _AddNewToolState();
}

class _AddNewToolState extends State<AddNewTool> {
    ...
    return Scaffold(
      ...
      body: Form(
        child: ListView(
          ...
          children: [
            Align(child: Text("Add Your Tool",style: TextStyle(color: Colors.green,fontSize: 30,fontWeight: FontWeight.bold),),alignment: Alignment.centerLeft,),
            SizedBox(height: 40,),
            Container(
